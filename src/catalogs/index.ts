export const Projects = [
  ...
  },
  {
    ...
    button: "HomePage",
    context:
      "This is a project based on the design of Edies homepage. The goal of this project is to replicate the design provided in Figma and create a functional web page that closely resembles the original design",
  ...
  },
  {
    ...
    button: "Animes",
    context:
      "The project is a web application that displays a list of animes (Japanese animated series and movies). Users can filter anime by status and type, explore details, and watch trailers. The interface has pagination buttons and uses a custom modal to display trailers.",
  ...
  },
  {
    ...
    button: "ShoppingCart",
    context:
      'The project is a simple online store built with React. The application displays a list of products, each with its name, price, and image. Users can add products to the shopping cart by clicking the "Add to Cart" button. The shopping cart shows the number of products added and can be opened and closed. The app also includes a navigation bar with a logo and a cart icon that shows the number of products in the cart. The interface uses a clean design and a modular component structure to display the products and manage the shopping cart.',
